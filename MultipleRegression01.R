...
#######################################################
##
## Reviewing simple regression by 
...
# lm(DV ~ IV, data="name of the dataset")
# Using Least Squared Sum Method

## STEP 3: Most important parts are : R^2, F-value and p-value
summary(simple.regression)

# R^2 = 0.613 , p-value = 0.012 
# -> weight does a pretty good job predicting a size.

abline(simple.regression, lwd=5, col="red")
#add a line that fits a Least-squares fit with color red.
...
# part 1
# (1) R^2 (2) adj R^2 (3) p-value all look good and statistically meaningful.(.)

# part 2
# By the Console line 'Coeeficients', second line 'weight' compares the multiple 
# regression to the simple regression
